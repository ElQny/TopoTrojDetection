...
POINTCLOUDS = True # For Poincloud classification
...
def main(
    ...
    psf_config['input_shape'] = INPUT_SIZE_PC if args.pointclouds else INPUT_SIZE_IMG
    ...
    #TODO: diesen Pfad für pointclouds noch nicht implementiert
    if CLASSIFIER=='mlp':
        if args.pointclouds==True:
